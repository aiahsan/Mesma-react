                        ...
                        >
                            {({ errors, touched, handleChange, handleBlur, values, handleSubmit, setFieldValue, getFieldProps }) => {
                                    ...
                                    <div id="Einloggen">
                                        ...
                                        <input type="text"  {...getFieldProps("email")} placeholder="Email" size="30" maxlength="15" required/><br></br>
                                        {touched.email && errors.email && <p style={{ color: 'red', marginTop: 10 }}>{errors.email}</p>}
                                        <input type="text"  {...getFieldProps("username")} placeholder="Benutzername" size="30" maxlength="15" required/><br></br>
                                        {touched.username && errors.username && <p style={{ color: 'red', marginTop: 10 }}>{errors.username}</p>}
                                    ...
                                    <div id="Klick">
                                        ...
                                        <button type="button" onClick={handleSubmit}>Registrieren</button>
